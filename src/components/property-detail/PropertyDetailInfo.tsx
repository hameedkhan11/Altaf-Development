...
import { Bed, Bath, Ruler, Utensils } from "lucide-react";
  ...
  return (
    <div className="w-full border-2 border-gray-200 rounded-lg relative overflow-hidden">
      <div className="w-full aspect-[4/3] sm:aspect-[5/4] md:aspect-[4/3] bg-gray-50 rounded-lg p-3 sm:p-4 md:p-6 flex flex-col justify-between min-h-0">
        ...
        <Link className="mt-2 sm:mt-3 md:mt-4 flex-shrink-0" href={"/contact"}>
          <Button
            className="w-full py-3 sm:py-4 md:py-5 text-sm sm:text-base bg-[rgb(140,46,71)] hover:bg-transparent border border-[rgb(140,46,71)] hover:text-[rgb(140,46,71)] text-white transition-all duration-300 ease-in rounded-full cursor-pointer"
