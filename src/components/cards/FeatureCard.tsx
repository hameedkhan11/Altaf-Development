...
const FeatureCard = ({ title, description, index, Icon }: FeatureCardProps) => {
  return (
    <motion.article
      ...
      className="relative group overflow-hidden rounded-3xl h-80 border border-black/60 shadow-lg bg-white"
    >
      {/* Card Content */}
      <div className="relative z-10 p-8 flex flex-col h-full">
        ...
        <div>
          <div className="inline-flex items-center">
            ...
            <div className="w-4 h-4 bg-[rgb(140,46,71)] rounded-full" />
          </div>
          <p
