...
export const chairmanData = {
  ...
  content: [
    ...
    "As we continue this journey, our promise remains unwavering: to lead with passion, build with purpose, and deliver with pride. Thank you for trusting us to be part of your story together, we are building a better tomorrow."
  ]
};
