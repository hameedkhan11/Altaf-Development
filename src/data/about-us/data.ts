...
export const ceoData = {
  ...
  content: [
    ...
    "At Altaf Developments, excellence isn’t just a goal, it’s the standard we live by. Every project reflects our dedication to creating spaces that inspire, elevate lifestyles, and deliver lasting value."
  ]
};

export const chairmanData = {
  name: "Altaf Khan",
  title: "Chairman, Altaf Developments",
  image: "Altaf_ggrxkm",
  content: [
    "At Altaf Developments, we believe that real estate is more than just building structures  it’s about shaping the future, enriching lives, and creating legacies that endure.",
